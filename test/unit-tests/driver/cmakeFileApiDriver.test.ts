...
async function cmakeFileApiDriverFactory(cmake: CMakeExecutable, config: ConfigurationReader, kit: Kit | null, workspaceFolder: string | null, preconditionHandler: any, preferredGenerators: CMakeGenerator[]) {
    const d = await CMakeFileApiDriver.create(cmake, config, workspaceFolder || "", false, kit, null, null, null, workspaceFolder, preconditionHandler, preferredGenerators);
    return d;
}
