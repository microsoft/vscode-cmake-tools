...
suite('Build using Kits and Variants', () => {
    ...
    let cmakeProjects: CMakeProject;
    ...
    suiteSetup(async function (this: Mocha.Context) {
        ...
        cmakeProjects = await CMakeProject.create(testEnv.vsContext, testEnv.wsContext);
    ...
    setup(async function (this: Mocha.Context) {
        ...
        const kit = await getFirstSystemKit(cmakeProjects);
    ...
    test('Test kit switch after missing preferred generator', async function (this: Mocha.Context) {
        ...
        await vscode.commands.executeCommand('cmake.setKitByName', (await getMatchingSystemKit(cmakeProjects, compiler[0].kitLabel)).name);

        await vscode.commands.executeCommand('cmake.build');

        testEnv.kitSelection.defaultKitLabel = compiler[1].kitLabel;
        await vscode.commands.executeCommand('cmake.setKitByName', (await getMatchingSystemKit(cmakeProjects, compiler[1].kitLabel)).name);
