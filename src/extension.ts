...
export async function activate(context: vscode.ExtensionContext) {
    ...
    if (oldCMakeToolsExtension) {
        await vscode.window.showWarningMessage(localize('uninstall.old.cmaketools', 'Please uninstall any older versions of CMake Tools. CMake Tools is now published by Microsoft starting with version 1.2.0.'));
    }
