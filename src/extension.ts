...
export class ExtensionManager implements vscode.Disposable {
    ...
    */
    ...
    private resolveProjectForTestCodeLens(testName: string, projectId: string | undefined): CMakeProject | undefined {
        ...
        log.error(localize('codelens.test.project.resolution.failed', "Unable to resolve the CMake project for test '{0}' (projectId: '{1}', reason: {2}).", testName, projectId ?? '', resolution.error));
