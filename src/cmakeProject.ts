...
export class CMakeProject {
    ...
    static async createForTest(config: ConfigurationReader, kit: Kit | null, workspaceFolder: vscode.WorkspaceFolder, extensionContext: vscode.ExtensionContext): Promise<CMakeProject> {
