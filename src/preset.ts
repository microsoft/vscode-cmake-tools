...
export function expandConfigurePreset(folder: string,
                                      name: string,
  ...
  return expandConfigurePresetImpl(folder, name, workspaceFolder, sourceDir, allowUserPreset);
}
...
export function expandBuildPreset(folder: string,
                                  name: string,
                                  workspaceFolder: string,
                                  sourceDir: string,
                                  allowUserPreset: boolean = false,
  ...
  return expandBuildPresetImpl(folder, name, workspaceFolder, sourceDir, allowUserPreset, configurePreset);
}
...
export function expandTestPreset(folder: string,
                                 name: string,
                                 workspaceFolder: string,
                                 sourceDir: string,
                                 allowUserPreset: boolean = false,
  ...
  return expandTestPresetImpl(folder, name, workspaceFolder, sourceDir, allowUserPreset, configurePreset);
}
