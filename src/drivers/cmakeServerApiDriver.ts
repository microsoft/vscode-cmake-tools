...
export class CMakeServerApiDriver extends CMakeDriver {
    ...
    static async create(cmake: CMakeExecutable,
        ...
        preferredGenerators: CMakeGenerator[]): Promise<CMakeServerApiDriver> {
        return this.createDerived(new CMakeServerApiDriver(cmake, config, workspaceFolder, preconditionHandler),
            useCMakePresets,
            kit,
            configurePreset,
            buildPreset,
