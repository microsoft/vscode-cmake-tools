...
import {BasicTestResults, CTestDriver} from './ctest';
...
export class CMakeTools implements vscode.Disposable, api.CMakeToolsAPI {
     ...
     */
    get buildType() {
        return this._buildType.value;
    }
    get onBuildTypeChanged() {
        return this._buildType.changeEvent;
    }
     ...
     */
    get codeModel() {
        return this._codeModel.value;
    }
    get onCodeModelChanged() {
        return this._codeModel.changeEvent;
    }
     ...
     */
    cleanConfigure() {
        return this.configure([], ConfigureType.Clean);
    }
