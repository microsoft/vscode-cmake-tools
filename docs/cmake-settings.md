...
| `cmake.colorizedBuildOutput` | Experimental, opt-in: colorize build output in the CMake/Build Output panel by highlighting errors, warnings, and notes using theme-aware ANSI colors. Requires VS Code 1.88 or newer. One of `off`, `severity`. | `off` | no |
