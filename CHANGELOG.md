...
## 1.9.1
Bug fixes:
- Fix processing of field condition in presets v3. [#2185](https://github.com/microsoft/vscode-cmake-tools/issues/2185)
...
- Exception after success build project. [#2188](https://github.com/microsoft/vscode-cmake-tools/issues/2188)
