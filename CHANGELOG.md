...
- Load the bundled language-service data (command, variable, module, and policy descriptions) on first hover/completion instead of during activation, so activation no longer blocks on reading those assets. [PLACEHOLDER-PR](https://github.com/microsoft/vscode-cmake-tools/pull/PLACEHOLDER-PR)
