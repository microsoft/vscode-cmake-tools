...
Bug Fixes:
- Fix build errors not appearing in the Problems tab and incorrect exit code when using `cmake.buildTask`. [#4489](https://github.com/microsoft/vscode-cmake-tools/issues/4489) [#3389](https://github.com/microsoft/vscode-cmake-tools/issues/3389)
