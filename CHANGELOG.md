...
Features:
- Add "Delete Build Directory and Reconfigure" command that removes the entire build directory before reconfiguring, ensuring a completely clean state. [#4833](https://github.com/microsoft/vscode-cmake-tools/issues/4833)
